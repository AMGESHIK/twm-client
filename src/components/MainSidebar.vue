<template>
  <div class="border-end bg-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush" >
      ...
      <router-link to="/diary"  class="list-group-item list-group-item-action list-group-item-light p-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
             class="bi bi-card-checklist me-2" viewBox="0 1 16 16">
          <path
      ...
      <router-link to="/chats" class="list-group-item list-group-item-action list-group-item-light p-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat me-2"
             viewBox="0 1 16 16">
          <path
